...
import CreateCityModal from "./CreateCommissionModal";
import EditCityModal from "./EditCommissionModal";
...
const Cities = memo(() => {
  ...
  const { data: commissionsData, isLoading } = useQuery({
    ...
    queryFn: async ({ queryKey }) => {
      ...
      const cachedData = queryClient.getQueryData(["commissions", params]);
      if (cachedData) {
        return cachedData;
      }
  ...
  return (
    <div style={{ padding: "16px" }}>
      ...
      <Table
        columns={columns}
        dataSource={commissionsData?.data || []}
        loading={isLoading}
        pagination={{
